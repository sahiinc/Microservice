...
public class CrmRestController {
	...
	@GetMapping("{identity}")
	public DetailedCustomerResponse getCustomerByIdentity(@PathVariable @TcKimlikNo String identity) throws CustomerNotFoundException {
	...
	@PostMapping
	public AcquireCustomerResponse acquireCustomer(@RequestBody @Validated AcquireCustomerRequest request) throws CustomerNotFoundException {
	...
	public UpdateCustomerResponse updateCustomer(@PathVariable @Validated @TcKimlikNo String identity,
			@RequestBody @Validated UpdateCustomerRequest request) throws CustomerNotFoundException {
	...
	public PatchCustomerResponse patchCustomer(@PathVariable @Validated @TcKimlikNo String identity,
			@RequestBody Map<String, Object> changes) throws CustomerNotFoundException {
		return crmApplication.patchCustomer(identity, changes);
	}

	@DeleteMapping("{identity}")
	public DeleteCustomerResponse releaseCustomerByIdentity(@PathVariable @TcKimlikNo String identity) throws CustomerNotFoundException {
